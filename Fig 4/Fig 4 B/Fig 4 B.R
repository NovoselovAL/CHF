...
###########################################################################################################################################################
#                                                                                                                                                         #
#                                                                Script for "figure 4 b" of paper                                                         # 
...
meta_table<- read.table("C:/path to/cytokines",row.names=1, header=TRUE, sep="\t")

#You can use sel_env_label to specify the labels for the panel, in case of "figure 4 b" we have to use cytokines

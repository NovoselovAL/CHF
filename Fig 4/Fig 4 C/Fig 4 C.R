...
###########################################################################################################################################################
#                                                                                                                                                         #
#                                                                Script for "figure 4 c" of paper                                                         # 
...
abund_table<-read.csv("C:/path to/abundance table_4c.csv",row.names=1,header=TRUE, sep=";")
#Transpose the data to have sample names on rows
abund_table<-t(abund_table)
meta_table<- read.table("C:/path to/Ct MiRNA",row.names=1, header=TRUE, sep="\t")

#You can use sel_env_label to specify the labels for the panel, in case of "figure 4 c" we have to use miRNA
...
write.table(df, "CorilationMiRNA_13_09_19.txt", col.names=NA, sep="\t")
